    ...
    <div className="min-h-screen px-4 py-8 bg-gray-50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 flex flex-col sm:flex-row gap-4 items-center">
          <h1 className="text-2xl font-bold text-gray-900 flex-1">Track Your Parcel</h1>
        ...
        {/* Tracking Events */}
        {isLoading && <p className="text-center text-gray-700">Loading tracking info…</p>}
        ...
        {trackingEvents && trackingEvents.length > 0 && (
          <div className="mt-6 space-y-4">
            {trackingEvents.map((event: ITrackingEvent, idx: number) => (
              <div
                key={idx}
                className="border-l-4 border-orange-500 pl-4 py-3 rounded-lg bg-white shadow-sm"
              >
